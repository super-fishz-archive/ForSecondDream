...
public class Chicken {
	...
	public int getSitePostNo() {
		return sitePostNo;
	}

	public void setSitePostNo(int sitePostNo) {
		this.sitePostNo = sitePostNo;
	}

	public String getWtrSplyFacilSeNm() {
		return wtrSplyFacilSeNm;
	}

	public void setWtrSplyFacilSeNm(String wtrSplyFacilSeNm) {
		this.wtrSplyFacilSeNm = wtrSplyFacilSeNm;
	}

	public int getManEipCnt() {
		return manEipCnt;
	}

	public void setManEipCnt(int manEipCnt) {
	...
	public String getMultUsnUpsoYn() {
		return multUsnUpsoYn;
	}

	public void setMultUsnUpsoYn(String multUsnUpsoYn) {
		this.multUsnUpsoYn = multUsnUpsoYn;
	}

	public String getLvSeNm() {
		return lvSeNm;
	}

	public void setLvSeNm(String lvSeNm) {
		this.lvSeNm = lvSeNm;
	}

	public String getFacilTotScp() {
		return facilTotScp;
	}

	public void setFacilTotScp(String facilTotScp) {
		this.facilTotScp = facilTotScp;
	}

	public int getWmEipCnt() {
		return wmEipCnt;
	}

	public void setWmEipCnt(int wmEipCnt) {
		this.wmEipCnt = wmEipCnt;
	}

	public String getTrdpJubnSeNm() {
		return trdpJubnSeNm;
	}

	public void setTrdpJubnSeNm(String trdpJubnSeNm) {
